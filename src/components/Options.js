    ...
    <Item.Group divided style={{ marginTop: "80px" }}>
      ...
      <Item>
        ...
        <Item.Content>
          ...
          <Item.Meta>
            <span className="cinema">
              Do I have what it takes to hack my company? Click the link to find
              out more.{" "}
            </span>
          </Item.Meta>
          <Item.Extra>
      ...
      {/* <Item>
        ...
        <Item.Content>
          ...
          <Item.Meta>
            <span className="cinema">Setting up a network in virtual box </span>
          </Item.Meta>
          <Item.Extra>
      ...
      {/* <Item>
        ...
        <Item.Content>
          ...
          <Item.Meta>
            <span className="cinema">
              Honeypots allow IT teams to gather valuable intelligence on
              hackers who are attempting to gain access to their networks.{" "}
            </span>
          </Item.Meta>
          <Item.Extra>
            <Label>AWS</Label>
